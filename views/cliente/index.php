<?php
  ...
  $query = "CALL spClienteCRUD(2, null, null, null, null, null, null);";
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
          ...
          <a href="../../views/cliente/correo/index.php" class="btn btn-outline-primary">Correos de Clientes</a>
          <a href="../../views/cliente/telefono/index.php" class="btn btn-outline-primary">Teléfonos de Clientes</a>
              ...
              <tbody>      
                <?php
                  while($row = $result->fetch()) {
                    ...
                    echo '<td>' . $row['FecRegistro'] . '</td>';
                    echo '<td><a class="btn btn-outline-success" href="editar.php?id=' . $row['IdCliente'] . '"><i class="fas fa-edit"></i></a> <a class="btn btn-outline-danger" href="eliminar.php?id=' . $row['IdCliente'] . '"><i class="far fa-trash-alt"></i></a></td>';
                    echo '</tr>';
                  }
                ?>
              </tbody>
