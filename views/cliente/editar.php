<?php
  ...
  if (isset($_POST['editar'])) {
    ...
    $query = "CALL spClienteCRUD(3, ?, ?, ?, ?, ?, ?);";
    $result = $pdo->prepare($query);
    $result->bindParam(1, $idCliente);
    $result->bindParam(2, $nuevoNombre);
    $result->bindParam(3, $nuevoAPaterno);
    $result->bindParam(4, $nuevoAMaterno);
    $result->bindParam(5, $_SESSION['idUsuario']);
    $result->bindParam(6, $nuevaFecRegistro);
...
<html lang="es">
  <head>
    ...
    <title>Editar Cliente | Hoteles</title>
          ...
          <?php
            if ($mensaje) {
              echo '<div class="alert alert-primary alert-dismissible fade show mt-3" role="alert">
                      <strong>Cliente editado</strong> correctamente.
          ...
          <form action="editar.php" method="post" class="mt-3">
            <div class="form-row">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="validationDefault01" name="nombre" value="<?php echo $nombre; ?>" maxlength="45" required />
              </div>
              <div class="col-md-4 mb-3">
                <label for="validationDefault02">Apellido Paterno:</label>
                <input type="text" class="form-control" id="validationDefault02" name="apaterno" value="<?php echo $aPaterno; ?>" maxlength="60" required />
              </div>
              <div class="col-md-4 mb-3">
                <label for="validationDefault03">Apellido Materno:</label>
                <input type="text" class="form-control" id="validationDefault03" name="amaterno" value="<?php echo $aMaterno; ?>" maxlength="60" required />
              </div>
            </div>
            <div class="form-row">
              <div class="col-md-4 mb-3">
                <label for="validationDefault04">Fecha de Registro:</label>
                <input type="date" class="form-control" id="validationDefault04" name="fecregistro" value="<?php echo $fecRegistro; ?>" required/>
              </div>
            </div>
