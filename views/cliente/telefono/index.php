<?php
  ...
  $query = "CALL spTelefonoCRUD(2, null, null, null,  null);";
              ...
              <tbody>      
                <?php
                  while($row = $result->fetch(PDO::FETCH_ASSOC)) {
                    echo '<tr>';
                    echo '<td>' . $row['IdTelefono'] . '</td>';
                    echo '<td>' . $row['Cliente'] . '</td>';
                    echo '<td>' . $row['Numero'] . '</td>';
                    echo '<td>' . $row['TipoTelefono'] . '</td>';
                    echo '<td><a class="btn btn-outline-success" href="editar.php?id=' . $row['IdTelefono'] . '"><i class="fas fa-edit"></i></a> <a class="btn btn-outline-danger" href="eliminar.php?id=' . $row['IdTelefono'] . '"><i class="far fa-trash-alt"></i></a></td>';
                    echo '</tr>';
                  }
                ?>
              </tbody>
