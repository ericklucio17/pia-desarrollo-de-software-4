<?php
  ...
  $query = "CALL spTipoCorreoCRUD(2, null, null);";
...
<html lang="es">
  <head>
    ...
    <title>Tipos de Correos | Hoteles</title>
            ...
            <table class="table table-hover table-dark">
              ...
              <tbody>      
                ...
                while($row = $result->fetch()) {
                  echo '<tr>';
                  echo '<td>' . $row['IdTipoCorreo'] . '</td>';
                  echo '<td>' . $row['Descrip'] . '</td>';
                  echo '<td><a class="btn btn-outline-success" href="editar.php?id=' . $row['IdTipoCorreo'] . '"><i class="fas fa-edit"></i></a> <a class="btn btn-outline-danger" href="eliminar.php?id=' . $row['IdTipoCorreo'] . '"><i class="far fa-trash-alt"></i></a></td>';
                  echo '</tr>';
                }
                ?>
              </tbody>
