<?php
  ...
  $query = "CALL spReservacionCRUD(2, null, null, null, null, null, null, null, null, null);";
...
<html lang="es">
  <head>
    ...
    <title>Reservaciones | Hoteles</title>
              ...
              <tbody>      
                <?php
                  while($row = $result->fetch()) {
                    ...
                    echo '<td>' . $row['FecInicio'] . '</td>';
                    echo '<td>' . $row['FecFin'] . '</td>';
                    echo '<td>' . $row['Monto'] . '</td>';
                    echo '<td>' . $row['FecRegistro'] . '</td>';
                    echo '<td>' . $row['Estatus'] . '</td>';
                    echo '<td><a class="btn btn-outline-success" href="editar.php?id=' . $row['IdReservacion'] . '"><i class="fas fa-edit"></i></a> <a class="btn btn-outline-danger" href="eliminar.php?id=' . $row['IdReservacion'] . '"><i class="far fa-trash-alt"></i></a></td>';
                    echo '</tr>';
                  }
                ?>
              </tbody>
