<?php
  ...
  $query = "CALL spHabitacionCRUD(2, null, null, null, null, null, null, null);";
...
<html lang="es">
  <head>
    ...
    <title>Habitaciones | Hoteles</title>
              ...
              <tbody>      
                <?php
                  while($row = $result->fetch()) {
                    ...
                    echo '<td>' . $row['TipoDeHabitacion'] . '</td>';
                    echo '<td>' . $row['Edificio'] . '</td>';
                    echo '<td>' . $row['Vista'] . '</td>';
                    echo '<td>' . $row['Estatus'] . '</td>';
                    echo '<td><a class="btn btn-outline-success" href="editar.php?id=' . $row['IdHabitacion'] . '"><i class="fas fa-edit"></i></a> <a class="btn btn-outline-danger" href="eliminar.php?id=' . $row['IdHabitacion'] . '"><i class="far fa-trash-alt"></i></a></td>';
                    echo '</tr>';
                  }
                ?>
              </tbody>
