    ...
    <div class="container-fluid">
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="sidebar-sticky pt-3">
            ...
            <ul class="nav flex-column mb-2">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="../../views/reporte3/index.php">
                  <span data-feather="file-text"></span>
                  Reporte 3
                </a>
              </li>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
          <h2>Reporte #3</h2>
          <p>Reporte de registros de habitaciones por tipo de habitación.</p>
          <div class="table-responsive mt-2">
            <table class="table table-hover table-dark">
              <thead>
                <tr>
                  <th>Habitación</th>
                  <th>Registro de habitaciones</th>
                </tr>
              </thead>
              <tbody>      
                <?php
                  while($row = $result->fetch()) {
                    ...
                    echo '<td>' . $row['REGISTRO_HABITACIONES'] . '</td>';
                    echo '</tr>';
                  }
                ?>
              </tbody>
