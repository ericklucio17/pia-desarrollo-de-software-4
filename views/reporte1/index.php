    ...
    <div class="container-fluid">
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="sidebar-sticky pt-3">
            ...
            <ul class="nav flex-column mb-2">
              <li class="nav-item">
                <a class="nav-link active" href="../../views/reporte1/index.php">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
          <h2>Reporte #1</h2>
          <p>Reporte de clientes registrados por cada usuario.</p>
              ...
              <tbody>      
                <?php
                  while($row = $result->fetch()) {
                    ...
                    echo '<td>' . $row['CLIENTES_REGISTRADOS'] . '</td>';
                    echo '</tr>';
                  }
                ?>
              </tbody>
