<?php
  ...
  $query = "CALL spCorreoCRUD(2, null, null, null, null);";
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
          ...
          <!-- <a href="../../../views/cliente/index.php" class="btn btn-secondary">Regresar a Clientes</a> -->
          <a href="../../../views/cliente/index.php" class="btn btn-outline-primary">Regresar a Clientes</a>
              ...
              <tbody>      
                <?php
                  while($row = $result->fetch()) {
                    echo '<tr>';
                    echo '<td>' . $row['IdCorreo'] . '</td>';
                    echo '<td>' . $row['Cliente'] . '</td>';
                    echo '<td>' . $row['Correo'] . '</td>';
                    echo '<td>' . $row['TipoCorreo'] . '</td>';
                    echo '<td><a class="btn btn-outline-success" href="editar.php?id=' . $row['IdCorreo'] . '"><i class="fas fa-edit"></i></a> <a class="btn btn-outline-danger" href="eliminar.php?id=' . $row['IdCorreo'] . '"><i class="far fa-trash-alt"></i></a></td>';
                    echo '</tr>';
                  }
                ?>
              </tbody>
