<?php
  ...
  $query = "CALL spEdificioCRUD(2, null, null, null);";
              ...
              <tbody>      
                <?php
                  while($row = $result->fetch()) {
                    ...
                    echo '<td>' . $row['Niveles'] . '</td>';
                    echo '<td><a class="btn btn-outline-success" href="editar.php?id=' . $row['IdEdificio'] . '"><i class="fas fa-edit"></i></a> <a class="btn btn-outline-danger" href="eliminar.php?id=' . $row['IdEdificio'] . '"><i class="far fa-trash-alt"></i></a></td>';
                    echo '</tr>';
                  }
                ?>
              </tbody>
