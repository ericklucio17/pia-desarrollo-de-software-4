<?php
  ...
  $query = "CALL spRolCRUD(2, null, null);";
              ...
              if (isset($_SESSION["rol"])) {
                if ($_SESSION["rol"] == 1) {
                  ...
                  <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="../../views/rol/index.php">
              ...
              <tbody>      
                <?php
                  while($row = $result->fetch()) {
                    ...
                    echo '<td><a class="btn btn-outline-success" href="editar.php?id=' . $row['IdRol'] . '"><i class="fas fa-edit"></i></a> <a class="btn btn-outline-danger" href="eliminar.php?id=' . $row['IdRol'] . '"><i class="far fa-trash-alt"></i></a></td>';
                    echo '</tr>';
                  }
                ?>
              </tbody>
