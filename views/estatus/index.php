<?php
  ...
  $query = "CALL spEstatusCRUD(2, null, null);";
                ...
                if ($_SESSION["rol"] == 1) {
                  ...
                  <ul class="nav flex-column">
                    ...
                    <li class="nav-item active">
                      <a class="nav-link active" href="../../views/estatus/index.php">
                        <span data-feather="users"></span>
                        Estatus
                      </a>
                    </li>
            ...
            <table class="table table-hover table-dark">
              ...
              <tbody>      
                ...
                while($row = $result->fetch()) {
                  ...
                  echo '<td><a class="btn btn-outline-success" href="editar.php?id=' . $row['IdEstatus'] . '"><i class="fas fa-edit"></i></a> <a class="btn btn-outline-danger" href="eliminar.php?id=' . $row['IdEstatus'] . '"><i class="far fa-trash-alt"></i></a></td>';
                  echo '</tr>';
                }
                ?>
              </tbody>
