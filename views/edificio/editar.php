<?php
  ...
  if (isset($_POST['editar'])) {
    ...
    $nuevaNiveles = $_POST['niveles'];

    $query = "CALL spEdificioCRUD(3, ?, ?, ?);";
    $result = $pdo->prepare($query);
    $result->bindParam(1, $idEdificio);
    $result->bindParam(2, $nuevaDescrip);
    $result->bindParam(3, $nuevaNiveles);
  ...
  if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM EDIFICIO WHERE IdEdificio= ?";
...
<html lang="es">
  <head>
    ...
    <title>Editar Edificio | Hoteles</title>
              ...
              if (isset($_SESSION["rol"])) {
                if ($_SESSION["rol"] == 1) {
                  ...
                  <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="../../views/edificio/index.php">
                        <span data-feather="users"></span>
                        Edificios
                      </a>
                    </li>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
          ...
          if ($mensaje) {
            echo '<div class="alert alert-primary alert-dismissible fade show mt-3" role="alert">
                    <strong>Edificio editado</strong> correctamente.
          ...
          <form action="editar.php" method="post" class="mt-3">
            <div class="form-row">
              <input type="hidden" name="idedificio" value="<?php echo $idEdificio ?>">
              <div class="col-md-6 mb-3">
                <label for="validationDefault01">Descripción</label>
                <input type="text" class="form-control" id="validationDefault01" name="descrip" value="<?php echo $descrip; ?>" maxlength="45" required />
              </div>
              <div class="col-md-6 mb-3">
                <label for="validationDefault02">Niveles</label>
                <input type="number" class="form-control" id="validationDefault02" name="niveles" value="<?php echo $niveles; ?>" required />
              </div>
            </div>
