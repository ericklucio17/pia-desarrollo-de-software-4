<?php
  ...
  if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM TIPOCORREO WHERE IdTipoCorreo= ?";
...
<html lang="es">
  <head>
    ...
    <title>Editar Tipo de Correo | Hoteles</title>
              ...
              if (isset($_SESSION["rol"])) {
                if ($_SESSION["rol"] == 1) {
                  ...
                  <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="../../views/tipocorreo/index.php">
                        <span data-feather="users"></span>
                        Tipos de Correos
                      </a>
                    </li>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
          ...
          if ($mensaje) {
            echo '<div class="alert alert-primary alert-dismissible fade show mt-3" role="alert">
                    <strong>Tipo de correo editado</strong> correctamente.
          ...
          <form action="editar.php" method="post" class="mt-3">
            <div class="form-row">
              <input type="hidden" name="idtipocorreo" value="<?php echo $idTipoCorreo ?>">
