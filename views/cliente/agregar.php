<?php
  ...
  if (isset($_POST['agregar'])) {
    ...
    $fechRegistro = $_POST['fecregistro'];

    $query = "CALL spClienteCRUD(1, null, ?, ?, ?, ?, ?);";
    $result = $pdo->prepare($query);
    $result->bindParam(1, $nombre);
    $result->bindParam(2, $aPaterno);
    $result->bindParam(3, $aMaterno);
    $result->bindParam(4, $_SESSION['idUsuario']);
    $result->bindParam(5, $fechRegistro);
...
<html lang="es">
  <head>
    ...
    <title>Agregar Cliente | Hoteles</title>
          ...
          <?php
            if ($mensaje) {
              echo '<div class="alert alert-primary alert-dismissible fade show mt-3" role="alert">
                      <strong>Cliente agregado</strong> correctamente.
          ...
          <form action="agregar.php" method="post" class="mt-3">
            <div class="form-row">
              <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="validationDefault01" name="nombre" maxlength="45" required />
              </div>
              <div class="col-md-4 mb-3">
                <label for="validationDefault02">Apellido Paterno:</label>
                <input type="text" class="form-control" id="validationDefault02" name="apaterno" maxlength="60" required />
              </div>
              <div class="col-md-4 mb-3">
                <label for="validationDefault03">Apellido Materno:</label>
                <input type="text" class="form-control" id="validationDefault03" name="amaterno" maxlength="60" required />
              </div>
            </div>
            <div class="form-row">
              <div class="col-md-4 mb-3">
                <label for="validationDefault04">Fecha de Registro:</label>
                <input type="date" class="form-control" id="validationDefault04" name="fecregistro" required />
              </div>
            </div>
