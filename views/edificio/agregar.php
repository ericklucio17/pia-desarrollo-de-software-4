<?php
  ...
  if (isset($_POST['agregar'])) {
    ...
    $query = "CALL spEdificioCRUD(1, null, ?, ?);";
    $result = $pdo->prepare($query);
    $result->bindParam(1, $descrip);
    $result->bindParam(2, $niveles);
...
<html lang="es">
  <head>
    ...
    <title>Agregar Edificio | Hoteles</title>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
          ...
          if ($mensaje) {
            echo '<div class="alert alert-primary alert-dismissible fade show mt-3" role="alert">
                    <strong>Edificio agregado</strong> correctamente.
          ...
          <form action="agregar.php" method="post" class="mt-3">
            <div class="form-row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control" id="validationDefault02" name="niveles" required />
              </div>
            </div>
