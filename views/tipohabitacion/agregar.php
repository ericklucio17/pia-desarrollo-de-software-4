<?php
  ...
  if (isset($_POST['agregar'])) {
    ...
    $query = "CALL spTipoHabitacionCRUD(1,null, ?, ?, ?);";
    $result = $pdo->prepare($query);
    $result->bindParam(1, $descrip);
    $result->bindParam(2, $precio);
    $result->bindParam(3, $capacidad);
...
<html lang="es">
  <head>
    ...
    <title>Agregar Tipo de Habitaciones | Hoteles</title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
          <h2>Agregar Tipo de Habitaciones</h2>
          ...
          if ($mensaje) {
            echo '<div class="alert alert-primary alert-dismissible fade show mt-3" role="alert">
                    <strong>Tipo de habitación agregada</strong> correctamente.
          ...
          <form action="agregar.php" method="post" class="mt-3">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="validationDefault01" name="descrip" maxlength="60" required />
              </div>
              <div class="col-md-6 mb-3">
                <label for="validationDefault02">Precio:</label>
                <input type="number" class="form-control" id="validationDefault02" name="precio" required />
              </div>
              <div class="col-md-6 mb-3">
                <label for="validationDefault03">Capacidad:</label>
                <input type="number" class="form-control" id="validationDefault03" name="capacidad" required />
              </div>
            </div>
