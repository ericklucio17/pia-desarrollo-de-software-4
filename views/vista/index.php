<?php
  ...
  $query = "CALL spVistaCRUD(2, null, null);";
              ...
              <tbody>      
                <?php
                  while($row = $result->fetch()) {
                    echo '<tr>';
                    echo '<td>' . $row['IdVista'] . '</td>';
                    echo '<td>' . $row['Descrip'] . '</td>';
                    echo '<td><a class="btn btn-outline-success" href="editar.php?id=' . $row['IdVista'] . '"><i class="fas fa-edit"></i></a> <a class="btn btn-outline-danger" href="eliminar.php?id=' . $row['IdVista'] . '"><i class="far fa-trash-alt"></i></a></td>';
                    echo '</tr>';
                  }
                ?>
              </tbody>
