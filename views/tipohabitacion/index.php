<?php
  ...
  $query = "CALL spTipoHabitacionCRUD(2, null, null, null, null);";
...
<html lang="es">
  <head>
    ...
    <title>Tipos de habitaciones | Hoteles</title>
              ...
              <tbody>      
                <?php
                  while($row = $result->fetch()) {
                    echo '<tr>';
                    echo '<td>' . $row['IdTipoHabitacion'] . '</td>';
                    echo '<td>' . $row['Descrip'] . '</td>';
                    echo '<td>' . $row['Precio'] . '</td>';
                    echo '<td>' . $row['Capacidad'] . '</td>';
                    echo '<td><a class="btn btn-outline-success" href="editar.php?id=' . $row['IdTipoHabitacion'] . '"><i class="fas fa-edit"></i></a> <a class="btn btn-outline-danger" href="eliminar.php?id=' . $row['IdTipoHabitacion'] . '"><i class="far fa-trash-alt"></i></a></td>';
                    echo '</tr>';
                  }
                ?>
              </tbody>
