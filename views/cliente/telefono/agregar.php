<?php
  ...
  if (isset($_POST['agregar'])) {
    ...
    if ($idCliente == "pordefecto" || $idTipoTelefono == "pordefecto") {
      $validacionCombos = true;
    } else {
      $query = "CALL spTelefonoCRUD(1, null, ?, ?, ?);";
      $result = $pdo->prepare($query);
      $result->bindParam(1, $idCliente);
      $result->bindParam(2, $numero);
      $result->bindParam(3, $idTipoTelefono);
...
<html lang="es">
  <head>
    ...
    <title>Agregar Teléfono | Hoteles</title>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
          ...
          if ($mensaje) {
            echo '<div class="alert alert-primary alert-dismissible fade show mt-3" role="alert">
                    <strong>Teléfono agregado</strong> correctamente.
          ...
          <form action="agregar.php" method="post" class="mt-3">
            <div class="form-row">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input type="number" class="form-control" id="validationDefault02" name="numero" maxlength="45" required />
              </div>
              <div class="col-md-4 mb-3">
                <label for="validationDefault03">Tipo de Telefono:</label>
                <select class="form-control" name="idtipotelefono" required>
                  <option value="pordefecto">Seleccione:</option>
                  <?php
