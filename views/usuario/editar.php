<?php
  ...
  if (isset($_POST['editar'])) {
    ...
    $nuevoAPaterno = $_POST['apaterno'];
    $nuevoAMaterno = $_POST['amaterno'];
    $nuevoIdRol = $_POST['idrol'];

    if ($nuevoIdRol == "pordefecto") {
      ...
      $query = "CALL spUsuarioCRUD(3, ?, ?, ?, ?, ?, ?, ?);";
      $result = $pdo->prepare($query);
      $result->bindParam(1, $idUsuario);
      $result->bindParam(2, $nuevoUsuario);
      $result->bindParam(3, $nuevaContra);
      $result->bindParam(4, $nuevoNombre);
      $result->bindParam(5, $nuevoAPaterno);
      $result->bindParam(6, $nuevoAMaterno);
      $result->bindParam(7, $nuevoIdRol);
...
<html lang="es">
  <head>
    ...
    <title>Editar Usuario | Hoteles</title>
          ...
          <?php
            if ($mensaje) {
              echo '<div class="alert alert-primary alert-dismissible fade show mt-3" role="alert">
                      <strong>Usuario editado</strong> correctamente.
          ...
          <form action="editar.php" method="post" class="mt-3">
            <div class="form-row">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="validationDefault01" name="usuario" value="<?php echo $usuario; ?>" maxlength="45" required />
              </div>
              <div class="col-md-4 mb-3">
                <label for="validationDefault02">Contraseña:</label>
                <input type="password" class="form-control" id="validationDefault02" name="contra" value="<?php echo $contra; ?>" maxlength="45" required />
              </div>
              <div class="col-md-4 mb-3">
                <label for="validationDefault03">Nombre:</label>
                <input type="text" class="form-control" id="validationDefault03" name="nombre" value="<?php echo $nombre; ?>" maxlength="50" required />
              </div>        
            </div>
            <div class="form-row">
              <div class="col-md-4 mb-3">
                <label for="validationDefault04">Apellido Paterno:</label>
                <input type="text" class="form-control" id="validationDefault04" name="apaterno" value="<?php echo $aPaterno; ?>" maxlength="50" required />
              </div>
              <div class="col-md-4 mb-3">
                <label for="validationDefault05">Apellido Materno:</label>
                <input type="text" class="form-control" id="validationDefault05" name="amaterno" value="<?php echo $aMaterno; ?>" maxlength="50" required />
              </div>
              <div class="col-md-4 mb-3">
                ...
                <select class="form-control" name="idrol" id="validationDefault06" required>
                    ...
                    <?php
                      ...
                      while($row = $resultComboRol->fetch()) {
                        if($row["IdRol"] == $idRol) { ?>
                          <option selected value="<?php echo $row["IdRol"] ?>"><?php echo $row["Descrip"] ?></option>
                        <?php } else {
                        ?> 
