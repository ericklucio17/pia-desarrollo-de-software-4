<?php
  ...
  $query = "CALL spReservacionDetalleCRUD(4, null, null, null, null, null);";
              ...
              <tbody>      
                <?php
                  while($row = $result->fetch()) {
                    echo '<tr>';
                    echo '<td>' . $row['IdReservacionDetalle'] . '</td>';
                    echo '<td>' . $row['IdReservacion'] . '</td>';
                    echo '<td>' . $row['Cliente'] . '</td>';
                    echo '<td>' . $row['FecIN'] . '</td>';
                    echo '<td><a class="btn btn-outline-primary" href="agregar.php?id=' . $row['IdReservacionDetalle'] . '"><i class="fas fa-plus-square"></i></a></td>';
                    echo '</tr>';
                  }
                ?>
              </tbody>
