<?php
  ...
  if (isset($_POST['agregar'])) {
    ...
    $correo = $_POST['correo'];
    $idTipoCorreo = $_POST['idtipocorreo'];

    if ($idCliente == "pordefecto" || $idTipoCorreo == "pordefecto") {
      $validacionCombos = true;
    } else {
      $query = "CALL spCorreoCRUD(1, null, ?, ?, ?);";
      $result = $pdo->prepare($query);
      $result->bindParam(1, $idCliente);
      $result->bindParam(2, $correo);
      $result->bindParam(3, $idTipoCorreo);
...
<html lang="es">
  <head>
    ...
    <title>Agregar Correo | Hoteles</title>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
          ...
          if ($mensaje) {
            echo '<div class="alert alert-primary alert-dismissible fade show mt-3" role="alert">
                    <strong>Correo agregado</strong> correctamente.
          ...
          <form action="agregar.php" method="post" class="mt-3">
            <div class="form-row">
              ...
              <div class="col-md-4 mb-3">
                ...
                <input type="email" class="form-control" id="validationDefault02" name="correo" maxlength="45" required />
              </div>
              <div class="col-md-4 mb-3">
                ...
                <select class="form-control" name="idtipocorreo" id="validationDefault03" required>
                  ...
                  while($row = $resultComboTipoCorreo->fetch()) { ?>
                    <option value="<?php echo $row["IdTipoCorreo"] ?>"><?php echo $row["Descrip"] ?></option>
                    <?php  
