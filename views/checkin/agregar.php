<?php
  ...
  if (isset($_POST['agregar'])) {
    ...
    $query = "CALL spReservacionDetalleCRUD(1, null, ?, ?, ?, ?);";
    $result = $pdo->prepare($query);
    $result->bindParam(1, $idReservacion);
    $result->bindParam(2, $idCliente);
    $result->bindParam(3, $fecIN);
    $result->bindParam(4, $fecIN);
  ...
  if (isset($_GET['id'])) {
    ...
    $query = "CALL spReservacionDetalleCRUD(3, null, ?, null, null, null);";
...
<html lang="es">
  <head>
    ...
    <title>Agregar Check IN | Hoteles</title>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
          ...
          if ($mensaje) {
            echo '<div class="alert alert-primary alert-dismissible fade show mt-3" role="alert">
                    <strong>Check In registrado</strong> correctamente.
          ...
          <form action="agregar.php" method="post" class="mt-3">
            <div class="form-row">
              <div class="col-md-4 mb-3">
                <label for="validationDefault01">Id Reservación:</label>
                <input type="text" class="form-control" id="validationDefault01" name="idreservacion" value="<?php echo $idReservacion; ?>" readonly />
              </div>
              <input type="hidden" name="idcliente" value="<?php echo $idCliente ?>">
              <div class="col-md-4 mb-3">
                <label for="validationDefault02">Cliente:</label>
                <input type="text" class="form-control" id="validationDefault02" value="<?php echo $cliente; ?>" readonly />
              </div>
              <div class="col-md-4 mb-3">
                <label for="validationDefault03">Check IN:</label>
                <input type="date" class="form-control" id="validationDefault03" name="fecin" value="<?php echo $fecIN; ?>" required />
              </div>
            </div>
