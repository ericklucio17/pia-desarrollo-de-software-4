<?php
  ...
  if (isset($_POST['editar'])) {
    ...
    $nuevaCapacidad = $_POST['capacidad'];

    $query = "CALL spTipoHabitacionCRUD(3, ?, ?, ?, ?);";
    $result = $pdo->prepare($query);
    $result->bindParam(1, $idTipoHabitacion);
    $result->bindParam(2, $nuevaDescrip);
    $result->bindParam(3, $nuevoPrecio);
    $result->bindParam(4, $nuevaCapacidad);
  ...
  if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM TIPOHABITACION WHERE IdTipoHabitacion= ?";
...
<html lang="es">
  <head>
    ...
    <title>Editar Tipo de Habitación | Hoteles</title>
      ...
      <div class="row">
              ...
              if (isset($_SESSION["rol"])) {
                if ($_SESSION["rol"] == 1) {
                  ...
                  <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="../../views/tipohabitacion/index.php">
                        <span data-feather="users"></span>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
          ...
          <?php
            if ($mensaje) {
              echo '<div class="alert alert-primary alert-dismissible fade show mt-3" role="alert">
                      <strong>Tipo de habitación editado</strong> correctamente.
          ...
          <form action="editar.php" method="post" class="mt-3">
            <div class="form-row">
              <input type="hidden" name="idtipohabitacion" value="<?php echo $idTipoHabitacion ?>">
              <div class="col-md-6 mb-3">
                <label for="validationDefault01">Descripción:</label>
                <input type="text" class="form-control" id="validationDefault01" name="descrip" value="<?php echo $descrip; ?>" maxlength="60" required />
              </div>
              <div class="col-md-6 mb-3">
                <label for="validationDefault02">Precio:</label>
                <input type="number" class="form-control" id="validationDefault02" name="precio" value="<?php echo $precio; ?>"  required />
              </div>
              <div class="col-md-6 mb-3">
                <label for="validationDefault03">Capacidad:</label>
                <input type="number" class="form-control" id="validationDefault03" name="capacidad" value="<?php echo $capacidad; ?>"  required />
              </div>
            </div>
