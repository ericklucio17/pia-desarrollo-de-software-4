<?php
  ...
  if (isset($_POST['agregar'])) {
    ...
    $query = "CALL spTipoTelefonoCRUD(1, null, ?);";
...
<html lang="es">
  <head>
    ...
    <title>Agregar Tipo de Teléfono | Hoteles</title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 mt-5">
          <h2>Agregar Tipo de Teléfono</h2>
          ...
          if ($mensaje) {
            echo '<div class="alert alert-primary alert-dismissible fade show mt-3" role="alert">
                    <strong>Tipo de teléfono agregado</strong> correctamente.
